...
def employee_view_customers():
    return render_template("employee_view_customers.html", list = db.showTransactionHistory(customerID))

@app.route("/manager_view_customers")
def emanager_view_customers():
    return render_template("manager_view_customers.html", list = db.showTransactionHistory(customerID))
